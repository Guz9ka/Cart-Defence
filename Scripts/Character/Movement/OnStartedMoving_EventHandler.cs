...
public class OnStartedMoving_EventHandler : MonoBehaviour
{
    ...
    private void HandleEvent(object s, EventArgs args)
    {
        ...
        _animationActivatorComponent.TriggerOnStartedMoving();
    }
    ...
    private void OnDisable()
    {
        ...
        {
            _movementComponent.OnStartedMoving -= HandleEvent;
        }
    }
